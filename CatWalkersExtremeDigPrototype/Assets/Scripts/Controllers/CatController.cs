...
public class CatController : MonoBehaviour {
	...
	void FixedUpdate(){
		Physics.IgnoreCollision (Camera.main.GetComponent<Collider> (), this.GetComponent<Collider> ());
	...
	public void setRandomPA(){
		pVars.powerAttackVal = Random.Range (0, 7);
		pVars.collected = true;
	}
